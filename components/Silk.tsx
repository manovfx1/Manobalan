...
const Silk: React.FC<SilkProps> = ({
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/immutability -- three.js shader uniforms are mutated in place by design; this is the standard r3f pattern for pushing prop updates to the GPU.
