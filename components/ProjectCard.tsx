    ...
    <AnimatedSection type={index % 2 === 0 ? "rotateInLeft" : "rotateInRight"} duration={1} delay={delay}>
      ...
      >
        <div ref={wrapRef} onMouseMove={handleMouseMove} className="card-shadow-wrap">
          <div
            className="media-dots relative w-full overflow-hidden rounded-2xl border border-black/30 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)] transition-colors duration-500 group-hover:border-[#EA580C]/70"
            style={{ aspectRatio }}
          >
            {project.coverImage ? (
              imageInset ? (
